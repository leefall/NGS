...
cnvkit.py sex /storage/home/leefall2/mypro/Cancer_Panel_Package/CNV/CNVkit/All_cnn/'''+str(sID)+'''.cnn '''+str(sFile)+''' cns/'''+str(sID)+'''.cns -o sex/'''+str(sID)+'''.sex
