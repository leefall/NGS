...
##############################################################################################################################
txtdir=./
export inSampleInfoTxt=${txtdir}/sampleInfo/Target001.txt  ### A txt file that contains sample?™s sex information.
export inAmpliconTxt=/storage/home/leefall2/mypro/Cancer_Panel_Package/DeviCNV_CancerPanel_probeInformation.txt  ### A txt file that contains the genomic position and pool information about target capture probes.
...
export inBamDir=/storage/home/leefall2/mypro/Cancer_Panel_Package/Bam/Target_001/  ### A directory that contains input bam files.
export codedir=./Code_v1.5.1/  ### A directory that contains code files.

export outdir=./Target001/  ### A name of your project directory.
export batchTag=Target001 ### A name of input batch of your project.
export datType="PCR"  ### "HYB" or "PCR".
...
export dupdelList="1.3_0.7" ### "1.2_0.8,1.3_0.7". "1.3_0.7" is recommended. "1.3" is for duplication and "0.7" is for deletion.
